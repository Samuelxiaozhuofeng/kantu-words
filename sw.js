...
const C = 'kantu-v3';
const FILES = ['./', 'index.html', 'app.js', 'lib.js', 'ai.js', 'tts.js', 'anki.js', 'editor.js', 'study.js', 'progress.js', 'stats.js', 'word.js', 'gen.js', 'home.js', 'scene.js', 'result.js', 'paint.js', 'packs.js', 'speech.js', 'manifest.json', 'icon.svg'];
